...
CREATE TABLE IF NOT EXISTS resultados (
  ...
  tipo_resultado ENUM('segundos','lineal','vertical_horizontal') NOT NULL DEFAULT 'segundos',
  ...
  valor_patron_grados_valfinal INT NOT NULL DEFAULT 0,
  valor_patron_minutos_valfinal INT NOT NULL DEFAULT 0,
  valor_patron_segundos_valfinal INT NOT NULL DEFAULT 0,
  ...
  valor_obtenido_grados_valfinal INT NOT NULL DEFAULT 0,
  valor_obtenido_minutos_valfinal INT NOT NULL DEFAULT 0,
  valor_obtenido_segundos_valfinal INT NOT NULL DEFAULT 0,
