import { CertificatesRepository } from '../../../data/certificates_repository'
...
export class CertificatesModalStore {
  ...
  async createCertificate(payload: { equipment_id: string; calibration_date: string; next_calibration_date: string; lab_conditions?: Record<string, unknown>; results: Record<string, unknown>; technician_id: string }){ return this.repo.createCertificateAndPdf(payload as any) }
